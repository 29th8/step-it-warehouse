...
import { History, Search, Filter, RefreshCw, Box, RotateCcw, Trash2, AlertTriangle } from "lucide-react";
...
export default function HistoryPage() {
  ...
  useEffect(() => {
    fetchMovements();
  }, [page, entityType, timeRange, executorId]);
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto flex-wrap">
            ...
            <Select value={timeRange} onValueChange={(val) => { setTimeRange(val); setPage(1); }}>
              <SelectTrigger className="h-11 w-full sm:w-[150px] bg-white border-slate-200 rounded-xl shadow-sm hover:bg-slate-50 transition-colors font-medium">
            ...
            <Select value={entityType} onValueChange={(val) => { setEntityType(val); setPage(1); }}>
              <SelectTrigger className="h-11 w-full sm:w-[170px] bg-white border-slate-200 rounded-xl shadow-sm hover:bg-slate-50 transition-colors font-medium">
            ...
            <Select value={executorId} onValueChange={(val) => { setExecutorId(val); setPage(1); }}>
              <SelectTrigger className="h-11 w-full sm:w-[180px] bg-white border-slate-200 rounded-xl shadow-sm hover:bg-slate-50 transition-colors font-medium">
