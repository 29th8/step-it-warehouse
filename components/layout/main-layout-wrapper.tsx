...
export function MainLayoutWrapper({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className={cn(
      ...
      <main className="flex-1 pb-20 md:pb-0 animate-in fade-in duration-500">
        {children}
      </main>
      ...
      {/* 4. Thêm mt-auto vào <footer>
          ...
          của flex container. */}
      <footer className="mt-auto hidden p-4 text-center text-xs text-slate-400 border-t bg-white md:block">
